...
SELECT emp.first_name,mgr.first_name,dep.department_name AS emp_dept_name,mgr_dep.department_name
FROM employees emp
JOIN employees mgr
ON emp.manager_id = mgr.employee_id
JOIN deparments dep 
...
AND emp.salary>(SELECT salary FROM emp WHERE first_name='Bruce')
AND mgr.salary>(SELECT salary FROM emp WHERE first_name = 'Sigal');
